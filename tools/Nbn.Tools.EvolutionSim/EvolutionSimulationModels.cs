...
public readonly record struct EvolutionSimulationStatus(
    ...
    float MinAssessmentSimilarityObserved,
    float MaxAssessmentSimilarityObserved,
    ulong ReproductionSimilaritySamples,
    float MinReproductionSimilarityObserved,
    float MaxReproductionSimilarityObserved,
    ulong SpeciationCommitSimilaritySamples,
    float MinSpeciationCommitSimilarityObserved,
    float MaxSpeciationCommitSimilarityObserved,
...
public readonly record struct SpeciationCommitOutcome(
    ...
    float? SourceSpeciesSimilarityScore = null);
