...
- Newborn derived species cannot split again until they have at least one in-species similarity sample; until then, threshold crossings are held in the newborn species rather than recursively fragmenting a one-sample/no-sample branch.
