...
- Direct live Brain reward-control is not a PPO action surface. It enters through IO/HiveMind direct runtime-control messages and must keep controller ids, reward signals, and action provenance separate from PPO's reproduction-action rollout metadata.
