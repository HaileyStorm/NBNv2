...
- Exposes canonical IO/proto wrappers for external runtime operations, including spawn/kill lifecycle forwarding, reproduction/speciation contract calls, and placement-worker capacity snapshots forwarded from HiveMind.
