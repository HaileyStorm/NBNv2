...
- Exposes canonical IO/proto wrappers for external runtime operations, including spawn/kill lifecycle forwarding, pause/resume brain control forwarding, direct runtime reward-control forwarding to HiveMind, separate queued-spawn and placed-and-visible wait acknowledgements, reproduction/speciation/PPO contract calls, global default and per-brain output-vector-source selection, barrier-coordinated whole-brain runtime state reset, and placement-worker capacity snapshots forwarded from HiveMind.
