...
- Barrier-coordinated runtime resets establish a per-router minimum accepted tick, clear superseded pending outboxes/deliveries/input drains, and ignore late router traffic from older ticks so paused-brain resets do not get stranded behind obsolete tick work.
