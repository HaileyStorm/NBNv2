...
public class VizActivityProjectionBuilderTests
{
    ...
    public void Build_MiniChart_TieBreaksDeterministicallyByLabel()
    {
        var events = new List<VizEventItem>
        {
            CreateEvent("VizAxonSent", tick: 300, region: 1, source: Address(1, 1), target: Address(1, 2), value: 0f, strength: 0f),
            CreateEvent("VizAxonSent", tick: 300, region: 2, source: Address(2, 1), target: Address(2, 2), value: 0f, strength: 0f)
        };
